...
class DashboardSalesAdapter(
    ...
    private val dataset: List<DashBoardSalesModel>
) : RecyclerView.Adapter<DashboardSalesAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
       ...
       Glide.with(context).load(item.imgDownloadUrl).into(holder.serviceImg)
